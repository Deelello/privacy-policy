...
<body>
  ...
  <p>All insamlad information används enbart för att förbättra appens prestanda och användarupplevelse. Vi delar inte informationen med tredje part för kommersiella ändamål.</p>

  <h2>3. Cookies och liknande teknik</h2>
  <p>Vi använder inte cookies eller spårning för reklamändamål. Endast nödvändig teknisk information kan samlas för appens funktionalitet.</p>

  <h2>4. Säkerhet</h2>
  <p>Vi vidtar rimliga tekniska och organisatoriska åtgärder för att skydda din information mot obehörig åtkomst, förändring eller radering.</p>

  <h2>5. Dina rättigheter</h2>
  <p>Du har rätt att begära information om de uppgifter vi har om dig och att begära att dessa uppgifter raderas.</p>
